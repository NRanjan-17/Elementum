...
struct S_Group: View {
    ...
    var body: some View {
        ...
        .navigationTitle("S Group Elements")
    }
    ...
    private func elementButton(for element: Element) -> some View {
        ...
        let isSBlock = element.block == "S Block"
        ...
        return Button {
            ...
            .foregroundColor(isSBlock ? .white : .gray)
            .background(isSBlock ? Color.blue : Color.gray.opacity(0.3))
            .cornerRadius(15)
            .opacity(isSBlock ? 1 : 0.5)
            .saturation(isSBlock ? 1 : 0)
        }
        .disabled(!isSBlock)
